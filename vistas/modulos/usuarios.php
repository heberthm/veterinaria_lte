    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:white; color:black">
          ...
          <h4 class="modal-title"><i class="fa fa-user"></i> &nbsp  Agregar usuario</h4>
        ...
        <div class="modal-body">
         ...
         <!-- ENTRADA PARA SUBIR FOTO -->
            ...
            <span class="btn btn-primary btn-file">
                       Buscar imágen     <input type="file" class="nuevaFoto" name="nuevaFoto">
            </span>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background:#white; color:black">
          ...
          <h4 class="modal-title"><i class="fa fa-pencil"></i>&nbsp  Editar usuario</h4>
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <div class="panel">SUBIR FOTO</div>
                 ...
                 <span class="btn btn-primary btn-file">
                     Buscar imágen      <input type="file" class="nuevaFoto" name="editarFoto">
            </span>
