              ...
              <div class="box">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-8 pull-right">
                    ...
                    <table class="table" class="table table-striped table-bordered" style="width: auto;  max-width: 200px;">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="nuevaFechaNacimiento" placeholder="Ingresar fecha nacimiento" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask required>
