...
var table = $('.tablaProductos').DataTable({
	...
	"columnDefs": [
...

		{
			"targets": -1,
			 "data": null,
			 "defaultContent": '<div class="btn-toolbar btn-xs"><button class="btn btn-warning btn-xs btnEditarProducto" idProducto data-toggle="modal" data-target="#modalEditarProducto"><i class="fa fa-pencil"></i></button><button class="btn btn-danger btn-xs btnEliminarProducto" idProducto codigo imagen><i class="fa fa-times"></i></button></div>'
