...
class ControladorEmpresa{
	...
	static public function ctrMostrarEmpresa($item, $valor, $orden){

		$tabla = "empresa";

		$respuesta = ModeloEmpresa::mdlMostrarEmpresa($tabla, $item, $valor, $orden);
	         ...
	         if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevaEmpresa"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["NuevaCiudad"])){
				...
				=============================================*/
			   	...
			   	$ruta = "vistas/img/productos/empresa/logo_empresa.png";
			   	...
			   	if(isset($_FILES["nuevaImagen"]["tmp_name"])){
					...
					if($_FILES["nuevaImagen"]["type"] == "image/png"){
						...
						$ruta = "vistas/img/productos/".$_POST["idCliente"]."/".$aleatorio.".png";
