             ...
             <div class="form-group">
              ...
              <div class="panel">SUBIR IMAGEN</div>
                ...
                <span class="btn btn-primary btn-file">
                           Buscar imágen      <input type="file" class="nuevaImagen" name="editarImagen">
                </span>
              ...
              <div class="col-md-6">  
                  ...
                  <img src="vistas/img/productos/default/anonymous.png" class="img-thumbnail previsualizar" width="120px">
             ...
             <div class="form-group row">
                ...
                <div class="col-xs-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control" id="editarPrecioCompra" name="editarPrecioCompra" min="0" required>
